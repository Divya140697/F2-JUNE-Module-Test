...
(function load(){
    ...
    for(x in students){
        ...
        <img  id="edit-btn" onclick="edit(${students[x].ID})" src="./image 1.png"> <img onclick="deleteStudent(${students[x].ID})" src="./image 2.png"></td></tr>`
    }
...
function searchStudents(){
    ...
    for(x in filter){
        ...
        <img  id="edit-btn" onclick="edit(${filter[x].ID})" src="./image 1.png"> <img onclick="deleteStudent(${filter[x].ID})" src="./image 2.png"></td></tr>`
    }
